!function(e, t) {
        ...
        r.state), o = 0; o < t.state.overlays.length; ++o)
            !function(e) {
                ...
                var o = t.state.overlays[e]
                  ...
                  , s = 0;
                r.state = !0,
                zt(t, n.text, o.mode, r, function(e, t) {
                    for (var n = l; s < e; ) {
                        var r = a[l];
    ...
    function In(e, t) {
        var n, r, i = H(t), o = zn(e, i), e = (o && !o.text ? o = null : o && o.changes && (wn(e, o, i, ur(e)),
                ...
                for (var v, y = 0; y < n.length; y++) {
                    ...
                    b.scrollToPos && (v = function(e, t, n, r) {
                        ...
                        for (var i = 0; i < 5; i++) {
                            ...
                            if (null != s.scrollTop && (zr(e, s.scrollTop),
    ...
    function pi(e, t) {
        ...
        if (r && s || n && a) {
            ...
            if (r && !d && !K && null != i)
                return n && a && zr(e, Math.max(0, l.scrollTop + n * i)),
    ...
    function Li(e, o, t, l) {
        ...
        var s, a = o.from, u = o.to, c = o.text, h = W(e, a.line), d = W(e, u.line), f = I(c), p = i(c.length - 1), g = u.line - a.line;
    ...
    function Di(e, t, n, r) {
        ...
        I(o.done)) : o.done.length && !I(o.done).ranges ? I(o.done) : 1 < o.done.length && !o.done[o.done.length - 2].ranges ? (o.done.pop(),
        I(o.done)) : void 0))
            i = I(o.changes),
        ...
        for (var r = [], i = 0; i < e.length; ++i) {
            ...
            if (o.ranges)
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    t)
                        for (var h in c)
                            (u = h.match(/^spans_(\d+)$/)) && -1 < L(t, Number(u[1])) && (I(s)[h] = c[h],
                            delete c[h])
                }
            }
        }
    ...
    function ro(e, t, n, r) {
        ...
        if (t.to.line < e.first)
            ...
            e.cm) {
                ...
                o.full ? z(i) : u.line != c.line || 1 != o.text.length || Si(i.doc, o) ? z(i, u.line, c.line + 1, l) : gr(i, u.line, "text"),
                d = je(i, "changes"),
                ((s = je(i, "change")) || d) && (l = {
                    from: u,
                    to: c,
    ...
    function Vo(e, t, n, r, i) {
        if (e) {
            ...
            if (e)
                return o = i < 0 == (1 == (e = i < 0 ? I(e) : e[0]).level) ? "after" : "before",
                0 < e.level || "rtl" == t.doc.direction ? (l = In(t, n),
    ...
    function Ko(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || In(t, n),
            rr(t, n, l, e)) : {
                begin: 0,
                end: n.text.length
            }
    ...
    function ll(e) {
        ...
        : function(d, e, f, p) {
            ...
            f = fr(d, e, !0, !0),
            v = -1) : (e = sl(d, f, p.unit),
            m = p.extend ? Ii(m, e.anchor, e.head, p.extend) : e);
    ...
    function p(e, t) {
        ...
        k(s.scroller, "scroll", function() {
            s.scroller.clientHeight && (zr(l, s.scroller.scrollTop),
        ...
        for (var i = 0; i < e.display.view.length; i++) {
            ...
            if (o.node == r) {
                ...
                if (o == s)
                    ...
                    l = 0,
                    !o)
                        return Al(F(H(c = u.rest ? I(u.rest) : u.line), c.text.length), a);
    ...
    r.prototype.pollContent = function() {
        ...
        for (var u = 0, c = 0, h = s[0], d = a[0], f = Math.min(h.length, d.length); u < f && h.charCodeAt(u) == d.charCodeAt(u); )
            ++u;
        for (var p = I(s), g = I(a), m = Math.min(p.length - (1 == s.length ? u : 0), g.length - (1 == a.length ? u : 0)); c < m && p.charCodeAt(p.length - c - 1) == g.charCodeAt(g.length - c - 1); )
            ++c;
    ...
    i.prototype.poll = function() {
        var e = this
          ...
          , n = this.textarea
          , r = this.prevInput;
        if (this.contextMenuPending || this.resetting || !t.state.focused || nt(n) && !r && !this.composing || t.isReadOnly() || t.options.disableInput || t.state.keySeq)
            return !1;
        var i = n.value;
    ...
    for (zl in f.prototype)
        f.prototype.hasOwnProperty(zl) && L(Il, zl) < 0 && (p.prototype[zl] = function(e) {
            return function() {
